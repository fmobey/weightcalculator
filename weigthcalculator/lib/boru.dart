...
class Boru extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  @override
  TextEditingController discap = TextEditingController(text: '');
  ...
  doAddition() {
    setState(() {
      discap1 = double.parse(discap.text.toString());
