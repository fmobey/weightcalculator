...
class Tprofil extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TextEditingController skalinlik = TextEditingController(text: '');
  ...
  doAddition() {
    setState(() {
      ...
      skalinlik1 = double.parse(skalinlik.text.toString());

      uzunluk1 = double.parse(uzunluk.text.toString());
      adet1 = double.parse(adet.text.toString());
      toplam = (((skalinlik1 * bkenari1 * 2) +
                  tkalinlik1 * (akenari1 - 2 * skalinlik1)) *
              uzunluk1 *
              adet1 *
              _katsayi) /
          1000000;
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: InputDecoration(labelText: 'T Thickness(mm) :'),
                inputFormatters: <TextInputFormatter>[
                  FilteringTextInputFormatter.digitsOnly
                ]),
          ),
          Padding(
            padding: const EdgeInsets.all(16),
            child: TextField(
                controller: skalinlik,
                keyboardType: TextInputType.number,
                decoration: InputDecoration(labelText: 'S Thickness(mm) :'),
                inputFormatters: <TextInputFormatter>[
                  FilteringTextInputFormatter.digitsOnly
                ]),
          ),
